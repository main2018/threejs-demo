...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      const { LightningStrike } = require('three/examples/jsm/geometries/LightningStrike.js');
      const { LightningStorm } = require('three/examples/jsm/objects/LightningStorm.js');
      ...
      const {default: Stats} = require('three/examples/jsm/libs/stats.module.js');
      const {default: {GUI}} = require('three/examples/jsm/libs/dat.gui.module.js');
      console.log('GUI ', GUI );
